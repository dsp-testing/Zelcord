...
sleep(5000).then(async () => {
    // dirty hack to make clicking notifications focus Zelcord
    addScript(`
        (() => {
...
setInterval(() => {
    ...
    el.id = "ac-ver";
    el.textContent = `Zelcord Version: ${version}`;
    ...
    acSettings.textContent = "Zelcord Settings";
