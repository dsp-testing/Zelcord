...
ipcRenderer.on("themeManifest", (_event, json) => {
    ...
    document.getElementById(`${id}header`)!.addEventListener("click", () => {
        ...
        if (manifest.supportsZelcordTitlebar !== undefined) {
            document.getElementById(
                "themeInfoButtons"
            )!.innerHTML += `<img class="themeInfoIcon" id="removeTheme" onclick="themes.uninstall('${id}')" title="Remove the theme" src="https://raw.githubusercontent.com/Zelcord/BrandingStuff/main/Trash.png"></img>
                           <img class="themeInfoIcon" id="updateTheme" onclick="themes.install('${manifest.updateSrc}')" title="Update your theme" src="https://raw.githubusercontent.com/Zelcord/BrandingStuff/main/UpgradeArrow.png"></img>
                           <img class="themeInfoIcon" id="compatibility" title="Supports Zelcord Titlebar" src=""></img>`;
            console.log("e");
            if (manifest.supportsZelcordTitlebar == true) {
                (document.getElementById(`compatibility`) as HTMLImageElement).src =
                    "https://raw.githubusercontent.com/Zelcord/BrandingStuff/main/Window.png";
            } else {
                (document.getElementById(`compatibility`) as HTMLImageElement).src =
                    "https://raw.githubusercontent.com/Zelcord/BrandingStuff/main/WindowUnsupported.png";
            }
        }
